...
const Carosel = () => {
    return (
        <div>
          ...
          <SwiperSlide>
              <div className="bg-cover bg-no-repeat w-full h-[480px]  py-40 flex flex-col items-center justify-center space-y-6 rounded-b-lg" style={{ backgroundImage: `url(${img1})` }}>
            ...
            <SwiperSlide>
              <div className="bg-cover bg-no-repeat w-full h-[480px]  flex flex-col items-center justify-center space-y-6 rounded-b-lg" style={{ backgroundImage: `url(${img2})` }}>
            ...
            <SwiperSlide>
              <div className="bg-cover bg-no-repeat w-full h-[480px]  flex flex-col items-center justify-center space-y-6 rounded-b-lg" style={{ backgroundImage: `url(${img3})` }}>
